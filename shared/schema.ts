...
export const duoFlow: FlowConfig = {
  ...
  pages: [
    ...
    { id: 1, path: "/duo/warnings", section: 0 },
    { id: 2, path: "/duo/intention", section: 1 },
    { id: 3, path: "/duo/sender-grounding", section: 1 },
    { id: 4, path: "/duo/receiver-grounding", section: 1 },
    { id: 5, path: "/duo/transition-1", section: 1 },
    { id: 6, path: "/duo/sender-situation", section: 2 },
    { id: 7, path: "/duo/sender-experience", section: 2 },
    { id: 8, path: "/duo/sender-interpretation", section: 2 },
    { id: 9, path: "/duo/sender-impact", section: 2 },
    { id: 10, path: "/duo/sender-summary", section: 2 },
    { id: 11, path: "/duo/receiver-validation", section: 3 },
    { id: 12, path: "/duo/sender-confirmation", section: 3 },
    { id: 13, path: "/duo/receiver-experience", section: 4 },
    { id: 14, path: "/duo/sender-validation", section: 5 },
    { id: 15, path: "/duo/receiver-confirmation", section: 5 },
    { id: 16, path: "/duo/transition-2", section: 5 },
    { id: 17, path: "/duo/sender-needs", section: 6 },
    { id: 18, path: "/duo/receiver-response", section: 6 },
    { id: 19, path: "/duo/transition-3", section: 6 },
    { id: 20, path: "/duo/sender-closing", section: 7 },
    { id: 21, path: "/duo/receiver-closing", section: 7 },
    { id: 22, path: "/duo/feedback", section: 7 },
    { id: 23, path: "/duo/completion", section: 7 },
    // Parcours inversé (7a-20a)
    { id: 24, path: "/duo/inversion-des-roles/page-7a", section: 2 },
    { id: 25, path: "/duo/inversion-des-roles/page-8a", section: 2 },
    { id: 26, path: "/duo/inversion-des-roles/page-9a", section: 2 },
    { id: 27, path: "/duo/inversion-des-roles/page-10a", section: 2 },
    { id: 28, path: "/duo/inversion-des-roles/page-11a", section: 2 },
    { id: 29, path: "/duo/inversion-des-roles/page-12a", section: 3 },
    { id: 30, path: "/duo/inversion-des-roles/page-13a", section: 3 },
    { id: 31, path: "/duo/inversion-des-roles/page-14a", section: 4 },
    { id: 32, path: "/duo/inversion-des-roles/page-15a", section: 5 },
    { id: 33, path: "/duo/inversion-des-roles/page-16a", section: 5 },
    { id: 34, path: "/duo/inversion-des-roles/page-17a", section: 5 },
    { id: 35, path: "/duo/inversion-des-roles/page-18a", section: 6 },
    { id: 36, path: "/duo/inversion-des-roles/page-19a", section: 6 },
    { id: 37, path: "/duo/inversion-des-roles/page-20a", section: 6 },
  ],
};
