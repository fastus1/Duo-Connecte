## **Page 17a - Transition besoins inversée (DuoInversionPage17a.tsx)**
...
C'est maintenant ton tour, {receiverName}

## Texte principal

Vous avez maintenant tous les deux partagé votre vécu et avez été validé·e·s dans votre perspective. {receiverName}, c'est à ton tour d'identifier ce dont tu as besoin pour améliorer la situation et renforcer votre connexion.

Cette étape t'aidera à transformer ton vécu en besoin, puis en pistes d'action concrètes.

## Texte secondaire

**Rappel :** La différence entre un **besoin**, un **désir** et une **demande** est essentielle pour formuler une proposition claire.

**Bouton: Revoir les concepts**

## Popup multi-pages

### Popup Page 1: Rappel - Besoin, Désir, Demande
...
Ta proposition pour combler le besoin. Elle est spécifique, réalisable et **négociable**.

### Popup Page 2: Pourquoi cette distinction est importante
...
### Popup Page 3: Processus complet - Exemple

**L'introspection:**

1. Besoin: "J'ai besoin de me sentir respecté·e et écouté·e"
2. Désir: "Je désire son attention quand on parle"
3. Demande: "Pourrais-tu me regarder quand je te parle?"

**Ce que tu dis à {senderName}:**
